---
clase: 14
titulo: Repaso para la evaluación — Unidad II
unidad: Unidad II
...
::q1
¿Por qué toda decisión económica implica un costo, aunque no paguemos nada?

::q2
Si el precio está por encima del equilibrio, ¿qué ocurre y cómo se corrige?

::q3
Un impuesto de $200 sobre un bien, ¿lo paga el comprador, el vendedor, o ambos?
...
::: mecanismo
::titulo
El mecanismo de ajuste — cuatro pasos

::subtitulo
Si el precio está por encima del equilibrio (P > Pe)

::paso1
**Excedente**
Qs supera a Qd. Los vendedores no logran colocar toda la producción.

::paso2
**Los vendedores bajan el precio**
Compiten entre sí para deshacerse del stock.

::paso3
**Qd sube y Qs baja**
Ley de la demanda + ley de la oferta, operando simultáneamente.
...
::texto
**Coincide exactamente con el impuesto.** Siempre. Por definición, Pc − Pv = T. Si no coincide, hay un número mal — revisar.
:::
...
::insight
Los consumidores cargan con el **70%** → la demanda es **inelástica**. Es el patrón que predice la teoría: a menor elasticidad de la demanda, mayor parte de la carga para el consumidor.
:::
